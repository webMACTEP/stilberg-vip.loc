...
$form['form-1'] = array(
	'fields' => array(
		'tell' => array(
			...
			'messages' => array(
				'preg' => 'Введите корректный номер телефона',
				'minlength' => 'Количество цифр в телефоне должно быть не менее  %2$s',
				'maxlength' => 'Максимальное количество цифр в телефоне превышает допустимую - %2$s',
			)
		),
		'text' => array(
			'title' => 'Сообщение',
		...
		'checkbox' => array(
			...
			'messages' => array(
				'minlength' => 'Необходимо согласиться с политикой конфиденциальности',
			)
		),
	),
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Тема письма',
		'title' => 'Получен заказ на VIP карту',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'admin@stilberg-vip.ru/',
		'from_name' => 'stilberg-vip.ru',
		'to_email' => '7286443@gmail.com, 6435181m@list.ru',
		...
		'okay' => '<h2>Спасибо!</h2>Заказ на получение VIP карты отправлен.<br/>Мы свяжемся с вами в ближайшее время.',
